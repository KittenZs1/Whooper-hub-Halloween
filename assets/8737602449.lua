...
return function()
    ...
    local main = win:Server("PLS DONATE", "")
    local main = main:Channel("Main")
    -- converting Untitled-2.lua to work with whopperhub
    -- Path: 8737602449.lua
    -- Compare this snippet from Untitled-2.lua:
    main:Textbox(
        "Donor's Username",
        "Whopperman2000",
        true,
    ...
    main:Textbox(
        ...
        true,
        function(Value)
            G.SmiteAnimationId = Value
        end	  
    )
    main:Textbox(
        "Dono Receiver's Username",
        "Whopperman2000",
        true,
        function(Value)
